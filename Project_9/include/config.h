...
// Retained LWT/availability topic. Broker sets this to "offline" (retained)
// automatically if the ESP32 disconnects uncleanly; ESP32 publishes "online"
// (retained) itself right after connecting.
#define TOPIC_DEVICE_STATUS        "device/esp32/status"
#define DEVICE_STATUS_ONLINE       "online"
#define DEVICE_STATUS_OFFLINE      "offline"
#define DEVICE_STATUS_QOS          1
